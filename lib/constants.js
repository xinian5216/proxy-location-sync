...
export const MSG = Object.freeze({
  ...
  OFFSCREEN_WORKER_PROBE: "OFFSCREEN_WORKER_PROBE",
});

export const ALARM_KEEPALIVE = "pls-keepalive";
export const ALARM_DNS = "pls-dns";
/** Firefox Event Page 短间隔轮询。Chromium 不用（走 Offscreen）。alarms 不跨 session 持久化。 */
export const ALARM_FIREFOX_POLL = "pls-firefox-poll";
